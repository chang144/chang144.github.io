import{_ as e,o as n,c as i,e as d}from"./app-5c7d7b5c.js";const s={},l=d(`<p>使用Docker 以及Docker Compose部署Go程序</p><h2 id="为什么需要docker" tabindex="-1"><a class="header-anchor" href="#为什么需要docker" aria-hidden="true">#</a> 为什么需要docker</h2><blockquote><p>使用docker的主要目标是其容器化。可以为应用程序提供一致的环境，而不依赖它运行的主机</p></blockquote><hr><h3 id="部署示例" tabindex="-1"><a class="header-anchor" href="#部署示例" aria-hidden="true">#</a> 部署示例</h3><h4 id="_1-准备代码" tabindex="-1"><a class="header-anchor" href="#_1-准备代码" aria-hidden="true">#</a> 1.准备代码</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package main
